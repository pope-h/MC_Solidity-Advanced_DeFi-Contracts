...
contract CryptoWalletInsurance is Ownable {
    ...
    constructor(address _insured, uint256 _policyType, address _defiScheme) Ownable(msg.sender) {
        ...
        // Define policies
        policies[1] = Policy(1 ether, 10 ether);  // Policy type 1
        policies[2] = Policy(2 ether, 20 ether);  // Policy type 2

        // Set the selected policy
        premium = policies[policyType].premium;
        coverageAmount = policies[policyType].coverageAmount;
    }
